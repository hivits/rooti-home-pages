...
<span class="flex h-[18px] items-center gap-[3px]" aria-hidden="true">
  ...
  </section>`}var s=`/assets/logo-white-CsR2MFCp.png`,c=`
...
<svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
  <path d="M12 19V6M6 12l6-6 6 6" stroke="#fff" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`,f=`relative w-full section-px py-16 md:py-[104px] scroll-mt-[72px]`;function p(e,t=`text-blue-primary`){return`<div class="mb-3 text-[15px] font-bold tracking-[0.18em] ${t}">${e}</div>`}function m(e){return`<h2 class="text-[32px] leading-[1.16] font-bold tracking-[-0.03em] text-ink-900 md:text-[46px]">${e}</h2>`}function h(e,t){return`
    <div class="mb-12 text-center" data-reveal>
      ${p(e)}
      ${m(t)}
    </div>`}function g(e){return`<span class="rounded-full border border-border-300 bg-surface-chip px-3 py-2 text-[14px] font-semibold whitespace-nowrap text-ink-500">${e}</span>`}function _(e,t,n){return`
    <div class="flex items-center gap-3.5 rounded-2xl border border-[#eef1f5] bg-white px-5 py-[18px] transition-colors duration-200 hover:border-blue-tint-border hover:bg-blue-tint/40" data-reveal>
    ...
    </div>`}var v=[`폐플라스틱`,`출근`,`루티 앱 실행`,`비츠봇`,`병뚜껑 분리 작업`,`업사이클링 키링 제작`];function y(){let e=v.map((e,t)=>`
      ...
      ${t<v.length-1?l:``}`).join(``);return`
  <section id="video" class="${f} flex flex-col items-center bg-surface-alt" data-screen-label="02 Video">
    ${h(`SEE ROOTI IN 30s`,`Rooti와 함께하는 하루`)}
    ...
    <div class="relative aspect-video w-[1000px] max-w-full overflow-hidden rounded-3xl bg-[linear-gradient(135deg,#1c3a2a,#101d36)] shadow-[0_50px_100px_-38px_rgb(16_26_48/0.46)]" data-reveal>
      ...
      <div class="absolute inset-0 flex flex-col items-center justify-center gap-5">
        <button class="flex size-24 cursor-pointer items-center justify-center rounded-full border-none bg-white/95 shadow-[0_16px_46px_rgb(0_0_0/0.32)] transition-transform duration-250 hover:scale-[1.07]" aria-label="소개 영상 재생">${u}</button>
        <div class="text-center text-white">
          <img src="${s}" alt="Rooti" class="inline-block h-[30px] w-auto" />
    ...
    <div class="flex flex-col" data-reveal>
      ...
      <div class="flex h-9 items-center justify-center">${c}</div>
  ...
  <section class="${f} flex flex-col bg-surface-alt" data-screen-label="03b Persona">
    ${h(`PROBLEM &amp; SOLUTION`,`루티가 해결하는 문제`)}
    <div class="grid grid-cols-1 items-stretch gap-6 md:grid-cols-3" data-reveal-stagger>${e}</div>
  </section>`}var w=`/assets/worker-1-Dl5jiNIC.png`,T=`/assets/worker-2-C_h5lgf-.png`,E=`/assets/worker-3-CKpPDhVH.png`,D=`/assets/worker-4-CMQ2aZCw.png`,O=`/assets/worker-5-BPYTc2lh.jpg`,k=[{title:`장애 맞춤형 UI · UX`,desc:`청각·시각·발달장애 접근성 설계`,icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="4.6" r="2" stroke="#8693AB" stroke-width="1.8"/><path d="M4.5 8.6h15M12 8.6v5M12 13.6l-3.2 6M12 13.6l3.2 6" stroke="#8693AB" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`},{title:`쉽고 편리한 근무 관리`,desc:`출퇴근·휴가·근로일지를 앱 하나로`,icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="4" y="5" width="16" height="16" rx="2.4" stroke="#8693AB" stroke-width="1.8"/><path d="M4 9h16M8 3v4M16 3v4M9 14l2 2 4-4" stroke="#8693AB" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`},{title:`음성 안내 및 쉬운 업무 지원`,desc:`음성 안내·인식과 쉬운 업무 안내`,icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 13a3 3 0 0 0 3-3V6a3 3 0 0 0-6 0v4a3 3 0 0 0 3 3Z" stroke="#8693AB" stroke-width="1.8"/><path d="M6 10a6 6 0 0 0 12 0M12 16v3" stroke="#8693AB" stroke-width="1.8" stroke-linecap="round"/></svg>`},{title:`빠른 소통`,desc:`관리자·보호자에게 즉시 전화 연결`,icon:`<svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M6 4l3 .6 1 3-2 1.4a11 11 0 0 0 6 6l1.4-2 3 1 .6 3a2 2 0 0 1-2.2 2A16 16 0 0 1 4 6.2 2 2 0 0 1 6 4Z" stroke="#8693AB" stroke-width="1.8" stroke-linejoin="round"/></svg>`}],A=`<svg width="30" height="30" viewBox="0 0 24 24" fill="none"><path d="M5 12.5l4.2 4.2L19 7" stroke="#1E7AE4" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>`,j=`absolute inset-0 will-change-[transform,opacity] motion-reduce:animate-none`,M=`absolute inset-0 h-full w-full`,N=`absolute left-[87.69%] -mt-3 -ml-3 size-6 origin-center motion-reduce:animate-none`,P=`absolute left-[87.69%] size-[38px] rounded-full bg-[rgb(30_122_228/0.32)] animate-rt-ripple motion-reduce:animate-none`,F=`absolute top-[84%] left-[4%] h-[7%] w-[92%] origin-center rounded-[14px] animate-rt-btn-press motion-reduce:animate-none`;function I(){let e=k.map(e=>_(e.icon,e.title,e.desc)).join(``);return`
  <section class="${f} grid grid-cols-1 items-center gap-8 bg-white md:grid-cols-[.9fr_1.1fr] md:gap-20" data-screen-label="07 Worker">
    <div class="flex items-center justify-center" data-reveal>
      <div class="relative w-[300px] drop-shadow-[0_42px_66px_rgb(16_26_48/0.28)]">
        <div class="relative w-full overflow-hidden rounded-[33px] bg-[#eff2f7] pt-[217.41%]">
          <div class="${j} animate-scr-1">
            <img src="${w}" alt="Rooti 근로자 앱 - 근무시간 전" class="${M}" />
          </div>
          <div class="${j} animate-scr-2">
            <img src="${T}" alt="Rooti 근로자 앱 - 시작 전 확인" class="${M}" />
            <span class="${N} top-[32.19%] animate-rt-pop-2">${A}</span>
            <span class="${N} top-[40.31%] animate-rt-pop-3">${A}</span>
            <span class="${P} top-[32.19%] [animation-delay:2.7s]"></span>
            <span class="${P} top-[40.31%] [animation-delay:3.5s]"></span>
            <span class="${F} bg-[rgb(30_122_228/0.18)] [animation-delay:4.7s]"></span>
          </div>
          <div class="${j} animate-scr-3">
            <img src="${E}" alt="Rooti 근로자 앱 - 지금 할 일" class="${M}" />
            <span class="${F} bg-[rgb(30_122_228/0.18)] [animation-delay:7.2s]"></span>
          </div>
          <div class="${j} animate-scr-4">
            <img src="${D}" alt="Rooti 근로자 앱 - 휴식 시간" class="${M}" />
            <span class="${F} bg-[rgb(20_150_110/0.18)] [animation-delay:10s]"></span>
          </div>
          <div class="${j} animate-scr-5">
            <img src="${O}" alt="Rooti 근로자 앱 - 완료" class="${M}" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      <div data-reveal>
        ${p(`FOR WORKERS · 근로자 앱`)}
        ${m(`누구나 쉽게 사용할 수 있는<br />장애 맞춤형 근무 앱`)}
  ...
  <section class="${f} grid grid-cols-1 items-center gap-8 bg-surface-alt md:grid-cols-[1.1fr_.9fr] md:gap-20" data-screen-label="08 Guardian">
    ...
    <div class="order-first flex items-center justify-center md:order-none" data-reveal>
      <div class="relative w-[300px] drop-shadow-[0_42px_66px_rgb(16_26_48/0.28)]">
        <img src="${L}" alt="Rooti 보호자 앱 - 홈 화면" class="w-full" />
      </div>
    </div>
  </section>`}var B=`/assets/admin-dashboard-C4rKldk0.png`,V=[`통합 근무관리`,`업무 생성 및 배치`,`출퇴근 관리`,`근로일지`,`전체 일정 관리`,`서류 관리`,`근로자 관리`];function ee(){let e=V.map(g).join(``);return`
  <section class="${f} flex flex-col bg-white" data-screen-label="09 Admin">
    <div class="mb-9 flex flex-wrap items-end justify-between gap-5" data-reveal-stagger>
      <div data-reveal>
        ${p(`FOR ENTERPRISE · 관리자 웹`)}
        ${m(`모든 근무 관리를 하나의 웹에서`)}
      </div>
    ...
    <div class="overflow-hidden rounded-[22px] border border-border-300 bg-white shadow-[0_50px_100px_-40px_rgb(16_26_48/0.4)]" data-reveal>
      ...
      <div class="aspect-[1909/815] w-full overflow-hidden bg-white">
        <img src="${B}" alt="Rooti 관리자 대시보드 화면" class="h-full w-full object-cover object-top" />
      </div>
    </div>
  </section>`}var H=[{value:`286`,unit:`명`,desc:`전국 거점에서 함께 일하는 장애인 고용 인원<br />(2025.12 계약 포함)`},{value:`90`,unit:`%`,desc:`고용부담금 감면 (최대)<br />PET 무인 수거 시스템 연계 도입 시 기업 혜택`}];function U(){let e=H.map(e=>`
      <div data-reveal>
  ...
  <section class="${f} flex flex-col bg-surface-alt" data-screen-label="06 Outcomes">
  ...
  <section id="esg" class="${f} flex flex-col overflow-hidden bg-white" data-screen-label="04 ESG">
  ...
  </section>`}var K=[{label:`회사명`,value:`하이비츠`},{label:`대표자`,value:`최찬숙`},{label:`사업자등록번호`,value:`788-86-01781`},{label:`주소`,value:`서울 구로구 디지털로31길 62<br />1013, 1014호 (구로동, 아티스포럼)`},{label:`대표번호`,value:`02-3281-8880`},{label:`이메일`,value:`<a class="text-white/92 no-underline hover:underline" href="mailto:hivits@naver.com">hivits@naver.com</a>`}],q=`mb-5 text-[16px] font-semibold tracking-[0.16em] text-white/50`,J=`text-[16px] text-white/90 no-underline hover:text-white`;function Y(){return`
  <footer id="contact" class="relative flex w-full flex-col items-center overflow-hidden bg-[linear-gradient(150deg,#142a52,#0d1b38)] pt-[120px] pb-14 section-px scroll-mt-[72px]" data-screen-label="10 Contact">
    ...
    <div class="relative mx-auto grid w-full max-w-[1320px] grid-cols-1 gap-10 md:grid-cols-[1.4fr_1fr_1fr]" data-reveal-stagger>
      <div data-reveal>
        <img src="${s}" alt="Rooti" class="h-[46px] w-auto opacity-95" />
      ...
      <div data-reveal>
        <div class="${q}">회사정보</div>
        <div class="flex flex-col gap-[18px]">${K.map(e=>`
      <div>
      ...
      <div data-reveal>
        ...
        <div class="flex flex-col gap-3">
          <a class="${J}" href="#">개인정보처리방침</a>
          <a class="${J}" href="#">이용약관</a>
        </div>
  ...
  </footer>`}var X=[`opacity-0`,`translate-y-2`,`pointer-events-none`],Z=[`opacity-100`,`translate-y-0`,`pointer-events-auto`];function Q(){return`
  <button
  ...
  >
    ${d}
  </button>`}function $(){let e=document.querySelector(`[data-back-to-top]`);if(!e)return;e.addEventListener(`click`,()=>{window.scrollTo({top:0,behavior:`smooth`})});let t=()=>{let t=window.scrollY>600;e.classList.remove(...t?X:Z),e.classList.add(...t?Z:X)};t(),window.addEventListener(`scroll`,t,{passive:!0})}var te=window.matchMedia(`(prefers-reduced-motion: reduce)`).matches;function ne(){document.querySelectorAll(`[data-reveal-stagger]`).forEach(e=>{e.querySelectorAll(`:scope > [data-reveal]`).forEach((e,t)=>{e.style.setProperty(`--reveal-delay`,`${t*80}ms`)})});let e=document.querySelectorAll(`[data-reveal]`);if(!e.length)return;let t=e=>{e.removeAttribute(`data-reveal`),e.style.removeProperty(`--reveal-delay`)},n=new IntersectionObserver(e=>{for(let r of e){if(!r.isIntersecting)continue;let e=r.target;e.classList.add(`is-revealed`),e.addEventListener(`transitionend`,()=>t(e),{once:!0}),setTimeout(()=>t(e),1800),n.unobserve(e)}},{threshold:.15,rootMargin:`0px 0px -8% 0px`});e.forEach(e=>n.observe(e))}function re(){let e=document.querySelectorAll(`[data-count-to]`);if(!e.length)return;let t=e=>{let t=Number(e.dataset.countTo??`0`);if(te||!Number.isFinite(t)){e.textContent=String(t);return}let n=0,r=i=>{n||=i;let a=Math.min((i-n)/1600,1),o=1-2**(-10*a);e.textContent=String(Math.round(t*o)),a<1?requestAnimationFrame(r):e.textContent=String(t)};requestAnimationFrame(r)},n=new IntersectionObserver(e=>{for(let r of e)r.isIntersecting&&(t(r.target),n.unobserve(r.target))},{threshold:.5});e.forEach(e=>n.observe(e))}function ie(){let e=document.querySelector(`header`);if(!e)return;let t=()=>{e.classList.toggle(`is-scrolled`,window.scrollY>8)};t(),window.addEventListener(`scroll`,t,{passive:!0})}document.documentElement.classList.add(`js`);var ae=document.querySelector(`#app`);ae.innerHTML=`
  ${t()}
  <main>
    ${o()}
    ${y()}
